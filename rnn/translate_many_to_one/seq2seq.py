...
def attention_decoder(decoder_inputs, initial_state, attention_states1, attention_states2, cell,
...
def embedding_attention_decoder(decoder_inputs, initial_state, attention_states1, attention_states2,
  ...
  with variable_scope.variable_scope(scope or "embedding_attention_decoder"):
    ...
    return attention_decoder(
        emb_inp, initial_state, attention_states1, attention_states2, cell, output_size=output_size,
...
#    shapes = [a.get_shape().as_list() for a in encoder_outputs]
#
#    print("shapes",shapes)
...
#    print("top_states",top_states)
    ...
    attention_states1 = array_ops.concat(1, top_states)
    attention_states2 = array_ops.concat(1, top_states)   
    #u scalaire, v vaut 1000 fois tan aussi de mille
#    top_states2 = top_states
#    attention_states2 = array_ops.concat(1, top_states2)
#    print("attention_states",attention_states)
#    attention_statess = array_ops.concat(1, [attention_states,attention_states2])
#    print("attention_statess",attention_statess)
#
#    print("##############################")
    ...
    if isinstance(feed_previous, bool):
      outputs,states = embedding_attention_decoder(
          decoder_inputs, encoder_state, attention_states1, attention_states2, cell,
  ...
  with ops.op_scope(all_inputs, name, "model_with_buckets"):
    ...
    for j, bucket in enumerate(buckets):
      with variable_scope.variable_scope(variable_scope.get_variable_scope(),
        ...
        #encoder_inputs[:bucket[0]] pour un le premier bucket retourne 5 premiers tenseurs                               
