...
# Use custom translation model (trained from PE data) to back-translate large monolingual corpus to French
...
moses_config=model/SMT/${model_corpus}_en-fr/moses.ini.tuned
script_dir=scripts
root_dir=seq2seq

n_splits=128
filename=${data_dir}/${mono_corpus}.tok.en
split_dir=${data_dir}/splits_en_fr
