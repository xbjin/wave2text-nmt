...
output_dir=`pwd`/experiments/SMT/model_no_punk
...
${mosesdecoder}/scripts/training/filter-model-given-input.pl ${output_dir}_filtered ${output_dir}/model/moses.ini ${output_dir}/concat.fr
