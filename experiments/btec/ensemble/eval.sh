...
config=experiments/btec/ensemble/model_3.yaml   # replace by best model
ensemble_dir=experiments/btec/ensemble
model_dir=${ensemble_dir}/model_3
...
#scripts/score.py experiments/SMT/model/dev.mt ${data_dir}/dev.en
#scripts/score.py experiments/SMT/model/test1.mt ${data_dir}/test1.en
#scripts/score.py experiments/SMT/model/test2.mt ${data_dir}/test2.en
#scripts/score.py experiments/SMT/model/dev.mt ${data_dir}/dev.mref.en
#scripts/score.py experiments/SMT/model/test1.mt ${data_dir}/test1.mref.en
#scripts/score.py experiments/SMT/model/test2.mt ${data_dir}/test2.mref.en
#scripts/score.py experiments/SMT/model/train.1000.mt ${data_dir}/train.1000.en
